<template>
    <nav class="flex flex-col bg-white" :class="setCollapsedState() + ' ' +  setCollapsedSessionState()" ref="menu"
        ...
        <a href="/reminder" class="p-4 rounded-r-full hover:bg-gray-200" :class="setActiveLink('reminder.index')">
        ...
        <a href="/archive" class="p-4 rounded-r-full hover:bg-gray-200" :class="setActiveLink('archive')">
        ...
        <a href="/trash" class="p-4 rounded-r-full hover:bg-gray-200" :class="setActiveLink('trash')">
