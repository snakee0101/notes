<template>
    <nav class="flex flex-col" style="width: 280px">
        ...
        <a href="/reminders" class="p-4 rounded-r-full hover:bg-gray-200">
        ...
        <a href="/archive" class="p-4 rounded-r-full hover:bg-gray-200">
        ...
        <a href="/trash" class="p-4 rounded-r-full hover:bg-gray-200">
